...
from pieces.bishop import Bishoop
...
class Board:
    ...
    def createBoard(self):
        ...
        self.gameTiles[2] = Tile(2, Bishoop("Black", 2))
        self.gameTiles[3] = Tile(3, Queen("Black", 3))
        self.gameTiles[4] = Tile(4, King("Black", 4))
        self.gameTiles[5] = Tile(5, Bishoop("Black", 5))
        ...
        self.gameTiles[58] = Tile(58, Bishoop("White", 58))
        self.gameTiles[59] = Tile(59, King("White", 59))
        self.gameTiles[60] = Tile(60, Queen("White", 60))
        self.gameTiles[61] = Tile(61, Bishoop("White", 61))
